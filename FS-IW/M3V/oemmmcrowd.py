import numpy as np
from M3V.M3VModel import M3VModel
...
class oemmmcrowd(M3VModel):
    ...
    def train(self):
        ...
        for iter in range(self.maxIter):
            ...
            # print(probd.sum(axis=0))

            # print(probd.sum(axis=0).reshape(1, self.Ndom, -1).repeat(axis=0, repeats=self.Ndom))
            #update eta
